...
SAVE_PATH = r"D:\Zainab\FYP\IntelliPlan-AI\images_masks\images_masks\model-epochs-500-1500"

BATCH_SIZE = 4
EPOCHS = 100                 # Continue for 60 more (you can adjust)
IMAGE_SIZE = 64
LATENT_DIM = 128
START_INDEX = 500           # Skip first 500 images
MAX_TRAIN_IMAGES = 1000     # Train on next 1000 (501–1500)
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu")
PRINT_EVERY = 1
SAVE_EVERY = 5
SEED = 42
PREV_CHECKPOINT = os.path.join(SAVE_PATH, "D:\Zainab\FYP\IntelliPlan-AI\images_masks\images_masks\model-epochs\checkpoint_epoch80.pth")
